...
/**
 *
 * @author Ezequirl Alexandre <ezequielaraujo1997@gmail.com>
 */
public class telaEquação extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Calcudora de Raiz²");

        txtA.setFont(new java.awt.Font("Cambria", 1, 18)); // NOI18N
        ...
        txtB.setFont(new java.awt.Font("Cambria", 1, 18)); // NOI18N
        ...
        txtC.setFont(new java.awt.Font("Cambria", 1, 18)); // NOI18N
        ...
        lblA.setFont(new java.awt.Font("Cambria", 1, 24)); // NOI18N
        lblA.setForeground(new java.awt.Color(255, 0, 0));
        lblA.setText("A");

        lblB.setFont(new java.awt.Font("Cambria", 1, 24)); // NOI18N
        lblB.setForeground(new java.awt.Color(255, 0, 0));
        lblB.setText("B");

        lblC.setFont(new java.awt.Font("Cambria", 1, 24)); // NOI18N
        ...
        btnCalc.setFont(new java.awt.Font("Cambria", 1, 18)); // NOI18N
        ...
        lblDelta.setFont(new java.awt.Font("Cambria", 1, 18)); // NOI18N
        lblDelta.setForeground(new java.awt.Color(0, 51, 204));
        lblDelta.setText("0");

        lblRaiz.setFont(new java.awt.Font("Cambria", 1, 18)); // NOI18N
